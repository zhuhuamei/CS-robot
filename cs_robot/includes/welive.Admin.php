...
function PrintHeader($username, $where = 'home') {
	...
	<div id="maindiv">
	<div id="header">
	<div class="logo"><align="absmiddle"> ' . SITE_TITLE . '</div>
	<div id="memu"><a href="admin.home.php" '.Iif($where=='home', 'class="on"').' hidefocus="true">首页</a><a href="admin.settings.php" '.Iif($where=='settings', 'class="on"').' hidefocus="true">设置</a><a href="admin.groups.php" '.Iif($where=='groups', 'class="on"').' hidefocus="true">群组</a><a href="admin.users.php" '.Iif($where=='users', 'class="on"').' hidefocus="true">用户</a><a href="admin.automsg.php" '.Iif($where=='automsg', 'class="on"').' hidefocus="true">常用短语</a><a href="admin.comments.php" '.Iif($where=='comments', 'class="on"').' hidefocus="true">留言</a></div>
